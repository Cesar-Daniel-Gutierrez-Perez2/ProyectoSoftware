...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        [HttpGet]
        public async  Task<ActionResult> ObtenerUsuario()
        {
        ...
        [HttpPost]
        public async Task<ActionResult> GuardarPerfil([FromBody] VMUsuario modelo)
        {
            GenericResponse<VMUsuario> response = new GenericResponse<VMUsuario>();
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult> CambiarClave([FromBody] VMCambiarClave modelo)
        {
